...
CREATE TABLE `t_sys_dict` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) DEFAULT NULL COMMENT '字典类型',
  `dict_name` varchar(40) DEFAULT NULL COMMENT '字典名称',
  `dict_code` varchar(32) DEFAULT NULL COMMENT '字典值',
  `dict_order` int(11) DEFAULT NULL COMMENT '排序',
  `dict_status` char(1) DEFAULT NULL COMMENT '1有效，0禁用',
  `description` varchar(255) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `creator` int(11) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `operator` int(11) DEFAULT NULL COMMENT '操作人',
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`),
  KEY `INDEX_DICT_NAME` (`dict_name`) USING BTREE
...
CREATE TABLE `t_sys_log` (
  ...
  `method_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '接口名称',
  `in_params` text COMMENT '入参',
  `out_params` text COMMENT '出参',
  `log_type` char(1) CHARACTER SET utf8 DEFAULT '1' COMMENT '日志类型 1、操作',
  `operation_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '操作名称',
  `operation_ip` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '操作的IP',
...
CREATE TABLE `t_sys_organization` (
  ...
  `ORGANIZATION_TYPE` char(1) DEFAULT NULL COMMENT '组织类型：1：事业部  2：机构  3：盐城',
  `ORGANIZATION_NAME` varchar(40) DEFAULT NULL COMMENT '组织名称',
  `ORGANIZATION_KEY` varchar(32) DEFAULT NULL COMMENT '组织编码',
  `ORGANIZATION_ICON` varchar(32) DEFAULT NULL COMMENT '组织图标',
  `ORGANIZATION_LEVEL` int(11) DEFAULT NULL COMMENT '组织级别（排序）',
  `BASIC_LAW` char(1) DEFAULT '1' COMMENT '是否适应基本法    0：否  1：是',
  ...
  `DEL_FLAG` char(1) DEFAULT '0' COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`ID`),
  KEY `INDEX_ORG_NAME` (`ORGANIZATION_NAME`) USING BTREE
...
CREATE TABLE `t_sys_organization_role` (
  ...
  `DEL_FLAG` char(1) DEFAULT '0' COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='可以给组织权限，在该组织下的所有用户都有此权限';

-- ----------------------------
-- Records of t_sys_organization_role
-- ----------------------------
INSERT INTO `t_sys_organization_role` VALUES ('1', '1', '0', '2016-04-20 14:21:12', '1', '2016-04-20 14:21:12', '1', '0');
...
CREATE TABLE `t_sys_resource` (
  ...
  `resource_key` varchar(32) DEFAULT NULL COMMENT '1、模块 2、菜单 3、按钮 4、链接',
  ...
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`),
  KEY `INDEX_PERM_NAME` (`resource_name`) USING BTREE,
...
CREATE TABLE `t_sys_role` (
  ...
  `ROLE_STATUS` char(1) DEFAULT '1' COMMENT '1有效，0禁用',
  `DESCRIPTION` varchar(255) DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
  `CREATOR` int(11) DEFAULT NULL,
  `UPDATE_TIME` datetime DEFAULT NULL,
...
CREATE TABLE `t_sys_role_resource` (
  ...
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='角色和权限关联表';

-- ----------------------------
-- Records of t_sys_role_resource
-- ----------------------------
INSERT INTO `t_sys_role_resource` VALUES ('1', '2', '1', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('2', '2', '3', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('3', '2', '4', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('4', '2', '15', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('5', '2', '5', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('6', '2', '6', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('7', '2', '7', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('8', '2', '2', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('9', '2', '8', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('10', '2', '9', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('11', '2', '10', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('12', '2', '11', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('13', '2', '12', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('14', '2', '13', '2018-10-27 19:24:13', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('16', '3', '14', '2018-11-09 21:26:59', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('17', '3', '16', '2018-11-09 21:26:59', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('18', '3', '17', '2018-11-09 21:26:59', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('19', '3', '18', '2018-11-09 21:26:59', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('21', '3', '20', '2018-11-09 21:26:59', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('64', '3', '37', '2018-12-24 14:05:22', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('65', '3', '39', '2018-12-27 14:49:58', '1', null, null, '0');
INSERT INTO `t_sys_role_resource` VALUES ('69', '3', '19', '2019-01-11 11:54:35', '1', null, null, '0');
...
CREATE TABLE `t_sys_user` (
  ...
  `USER_SEX` char(1) DEFAULT '2' COMMENT '1 : 男，0 : 女',
  ...
  `USER_STATUS` char(1) DEFAULT '1' COMMENT '''0''禁用，''1'' 启用, ''2'' 密码过期或初次未修改',
  `HEAD_IMG_URL` varchar(255) DEFAULT NULL,
  `PROVINCE` varchar(32) DEFAULT NULL COMMENT '省',
  `CITY` varchar(32) DEFAULT NULL COMMENT '市',
  `AREA` varchar(32) DEFAULT NULL COMMENT '区',
  `STREET` varchar(255) DEFAULT NULL COMMENT '街道详细地址',
  ...
  KEY `INDEX_USER_PHONE` (`USER_MOBILE`) USING BTREE,
...
CREATE TABLE `t_sys_user_info` (
  ...
  `WEI_XIN_NUM` varchar(20) DEFAULT NULL COMMENT '微信号',
  ...
  `CARD_PIC_ONE` varchar(255) DEFAULT NULL,
  `CARD_PIC_TWO` varchar(255) DEFAULT NULL,
  `GRADUATED` varchar(32) DEFAULT NULL COMMENT '毕业院校',
  `GRADUATED_DATE` date DEFAULT NULL COMMENT '毕业时间',
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '添加时间',
  `CREATOR` int(11) DEFAULT NULL COMMENT '添加人',
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '更新时间',
  `OPERATOR` int(11) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户和角色关联表';
...
SELECT A.sno,A.rid,A.depth,A.is_leaf,B.id, B.parent_id, B.dict_name, B.dict_code, B.dict_order, B.dict_status, B.description, B.create_time, B.creator, B.update_time, B.operator
...
SELECT A.SNO,A.RID,A.DEPTH,A.IS_LEAF,B.ID,B.ROLE_NAME,B.ROLE_KEY,B.PARENT_ID,B.CREATE_TIME,B.UPDATE_TIME,B.OPERATOR,B.DESCRIPTION 
