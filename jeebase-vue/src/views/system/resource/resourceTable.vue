<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input :placeholder="$t('resourceTable.resourceName')" v-model.trim="treeQuery.resourceName" style="width: 150px;" class="filter-item" maxlength="32"/>
      <el-input :placeholder="$t('resourceTable.resourceKey')" v-model.trim="treeQuery.resourceKey" style="width: 150px;" class="filter-item" maxlength="11"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="resourceForm" :model="resourceForm" :rules="rules" label-width="100px" class="resourceForm" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('resourceTable.description')">
          <el-input :autosize="{ minRows: 2, maxRows: 4}" v-model.trim="resourceForm.description" type="textarea" placeholder="请输入备注信息"/>
        </el-form-item>
      </el-form>
