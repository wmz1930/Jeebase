<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input :placeholder="$t('organizationTable.organizationName')" v-model.trim="treeQuery.organizationName" style="width: 150px;" class="filter-item" maxlength="32"/>
      <el-input :placeholder="$t('organizationTable.organizationKey')" v-model.trim="treeQuery.organizationKey" style="width: 150px;" class="filter-item" maxlength="11"/>
