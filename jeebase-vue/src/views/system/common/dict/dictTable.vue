<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input :placeholder="$t('dictTable.dictName')" v-model.trim="treeQuery.dictName" style="width: 150px;" class="filter-item" maxlength="32"/>
      <el-input :placeholder="$t('dictTable.dictCode')" v-model.trim="treeQuery.dictCode" style="width: 150px;" class="filter-item" maxlength="11"/>
    ...
    <tree-table :data="list" :eval-func="func" :eval-args="args" :expand-all="expandAll" :expand-title="expandTitle" :expand-name="expandName" border>
      ...
      <el-table-column :label="$t('table.actions')" width="300">
        <template slot-scope="scope">
          <el-button v-if="scope.row.parentId=='0'" type="primary" size="mini" @click="handleCreate(scope.row)">{{ $t('table.add') }}</el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dictForm" :model="dictForm" :rules="rules" label-width="100px" class="dictForm" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('dictTable.description')">
          <el-input :autosize="{ minRows: 2, maxRows: 4}" v-model.trim="dictForm.description" type="textarea" placeholder="请输入备注信息"/>
        </el-form-item>
      </el-form>
